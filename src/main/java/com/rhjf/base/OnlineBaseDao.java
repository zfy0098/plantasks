...
public class OnlineBaseDao {
    ...
    public int executeSql(String sql, Object[] params) {
        ...
        try {
            connection = OnlineConnectionFactory.getInstance().getConnection();
            ...
            OnlineConnectionFactory.getInstance().closeConnection(connection,
    ...
    public int[] executeBatchSql(String sql, Object[][] paramsArr) {
        ...
        try {
            ...
            OnlineConnectionFactory.getInstance().closeConnection(connection,preparedStatement, resultSet);
        }
        return null;
    }
...
//			log.error(e.getMessage());
    ...
    public int executeProcedure(String name) {
        ...
        ResultSet rs = null;
        try {
            conn = OnlineConnectionFactory.getInstance().getConnection();
            ...
            cStmt = null;
            OnlineConnectionFactory.getInstance().closeConnection(conn, null, rs);
        }
        return seqNo;
    }
}
