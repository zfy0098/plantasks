...
public class AppCheck extends BaseDao {
	...
	public void init() throws Exception {
		...
		String copyOrderSql = "insert into tab_pay_copyorder "
				...
				+ " from tab_pay_order where tradedate=? and PayRetCode='0000' and channelID='RONGHUI' ";
		...
		String saveReconciliation = "insert into tab_order_reconciliation" +
				" (ID,MerchantID,OrderNumber,CheckFee,CheckAmount,CheckOrderStatus,CheckWithdrawStatus,TradeDate , ChannelID) "
				+ " values (?,?,?,?,?,?,?,? , 'RONGHUI')";
