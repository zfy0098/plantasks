...
public class ImagePreProcess4 {
    ...
    public static String getAllOcr(String file) throws Exception {
        ...
        ImageIO.write(img, "JPG", new File("/train4//" + result + ".jpg"));
        return result;
    }
    ...
    public static void downloadImage() {
        ...
        HttpGet getMethod = new HttpGet("https://admin.jfpays.com/captcha.jpg");

        HttpClient httpClient = HttpClients.custom().setDefaultRequestConfig(null).build();
        ...
        try {
            ...
            OutputStream outStream = new FileOutputStream("e:/e.jpg");
