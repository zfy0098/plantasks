...
public class OnlinePartnerProfitYangTingSheng extends BaseDao {
	...
	static {
		...
		json = new JSONObject();
		json.put("id", "181");
		json.put("agentName", "速域（上海）资产管理股份有限公司");
		json.put("wxt0", 2.6);
		json.put("wxt1", 2.5);
		json.put("alipayt0",2.6);
		json.put("alipayt1", 2.6);
		json.put("qqt0", 0);
		json.put("qqt1", 0);
		json.put("kuait0", 0);
		json.put("kuait1", 0);
		...
		json = new JSONObject();
		json.put("id", "222");
		json.put("agentName", "深圳璞玉如金投资有限公司");
		json.put("wxt0", 2.7);
		json.put("wxt1", 2.6);
		json.put("alipayt0", 2.7);
		json.put("alipayt1", 2.6);
		json.put("qqt0", 2.7);
		json.put("qqt1", 2.6);
		json.put("kuait0", 3.5);
...
//				String createDate = agentInfo.get("createDate");
		...
		createExcel2(title, proftlist, sheetName ,pathName, "杨廷生");
	}
	...
	public static void main(String[] args) throws Exception {
		OnlinePartnerProfitYangTingSheng onlinePartnerProfit = new OnlinePartnerProfitYangTingSheng();
