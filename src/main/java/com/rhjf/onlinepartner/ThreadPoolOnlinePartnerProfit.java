...
public class ThreadPoolOnlinePartnerProfit extends BaseDao {
	...
	public class Task implements Runnable {
		...
		private JSONObject partnerRate ;
	...
	public void init() throws Exception {
		...
		for (int j = 0; j < array.size(); j++) {
			...
			sheetName.add(partnerRate.getString("name"));
		...
		createExcel2(title, proftlist, sheetName ,pathName, "ceshi");
	}
	...
	public static void main(String[] args) throws Exception {
		ThreadPoolOnlinePartnerProfit onlinePartnerProfit = new ThreadPoolOnlinePartnerProfit();
