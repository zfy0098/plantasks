...
public class OnlinePartnerProfit2 extends BaseDao {
	...
	static {
		...
		json.put("id", "175");
		json.put("agentName", "深圳云淘科技有限公司二级");
		json.put("wxt0", 2.5);
		json.put("wxt1", 2.4);
		...
		partnerRate.put("ratio", 1);
		partnerRate.put("wxt0", 3);
		partnerRate.put("wxt1", 2.8);
		partnerRate.put("alipayt0", 3);
		partnerRate.put("alipayt1", 2.8);
		partnerRate.put("qqt0", 3);
		partnerRate.put("qqt1", 2.8);
	...
	public static void main(String[] args) throws Exception {
		OnlinePartnerProfit2 onlinePartnerProfit = new OnlinePartnerProfit2();
